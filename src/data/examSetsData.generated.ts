// AUTO-GENERATED: Additional exam sets to be merged into examSetsData.ts
// This file contains 20+ sets per exam type with proper difficulty levels

import { ExamSet } from './examSetsData';

export const additionalSSCSets: ExamSet[] = [
    // SSC CHSL Sets 11-35 (Easy: 8, Medium: 17, Hard: 10)
...
export const additionalRRBSets: ExamSet[] = [
    // RRB NTPC Sets 6-35 (Easy: 10, Medium: 12, Hard: 8)
...
export const additionalBankingSets: ExamSet[] = [
    // SBI PO Sets 6-35 (Easy: 8, Medium: 14, Hard: 8)
    { id: "sbi-po-6", examId: "sbi-po", title: "SBI Set 6 (Medium)", language: "english", difficulty: "medium", content: "Credit cards are payment cards issued to users as a method of payment. They allow the cardholder to pay for goods and services based on the holder's promise to pay for them. The issuer creates a revolving account and grants a line of credit." },
];

// Note: This is a starter template. Full implementation would include 30+ sets per exam type.
